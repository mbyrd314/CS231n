...
def adam(x, dx, config=None):
  ...
  #Bias corrections used primarily for the first few iterations
  m_bias = config['m'] / (1 - beta1**config['t']) #Bias-corrected m
  v_bias = config['v'] / (1 - beta2**config['t']) #Bias-corrected v
